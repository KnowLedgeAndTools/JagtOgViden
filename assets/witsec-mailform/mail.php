...
$to = "steenosterby@gmail.com";														// To Address
$from = "steenosterby@gmail.com";													// From Address
$fromName = "JagtOgViden - Morten Janichen";											// From Name
...
$autorespondSubjectPrefix = "Angående mentor plan";			// Autorespond Form Subject Prefix
$autorespondSubject = "";						// Autorespond Custom Subject
$autorespondTemplate = "Hej<br>Tak for din mail.";					// Autorespond Template
